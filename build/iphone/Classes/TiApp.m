...
- (NSString*)userAgent
{
	if (userAgent==nil)
	{
		...
		NSString *k_titaniumnightclubNightClubUserAgentPrefix = [NSString stringWithFormat:@"%s%s%s %s%s","Appc","eler","ator","Tita","nium"];
		userAgent = [[NSString stringWithFormat:@"%@/%s (%@)",k_titaniumnightclubNightClubUserAgentPrefix,TI_VERSION_STR,currentDeviceInfo] retain];
	}
	return userAgent;
}
