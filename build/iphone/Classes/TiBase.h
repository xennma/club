...
// in simulator we redefine to format for _titaniumnightclubNightClub Developer console
...
{\
	NSString * exceptionName = [@"org.titaniumnightclub." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titaniumnightclub";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UI_titaniumnightclubNightClubNativeItemNone = -1, 
	UI_titaniumnightclubNightClubNativeItemSpinner = -2,
	UI_titaniumnightclubNightClubNativeItemProgressBar = -3,
	
	UI_titaniumnightclubNightClubNativeItemSlider = -4,
	UI_titaniumnightclubNightClubNativeItemSwitch = -5,
	UI_titaniumnightclubNightClubNativeItemMultiButton = -6,
	UI_titaniumnightclubNightClubNativeItemSegmented = -7,
	
	UI_titaniumnightclubNightClubNativeItemTextView = -8,
	UI_titaniumnightclubNightClubNativeItemTextField = -9,
	UI_titaniumnightclubNightClubNativeItemSearchBar = -10,
	
	UI_titaniumnightclubNightClubNativeItemPicker = -11,
	UI_titaniumnightclubNightClubNativeItemDatePicker = -12,
	
	UI_titaniumnightclubNightClubNativeItemInfoLight = -13,
	UI_titaniumnightclubNightClubNativeItemInfoDark = -14,
	
	UI_titaniumnightclubNightClubNativeItemDisclosure = -15,
	
	UI_titaniumnightclubNightClubNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all _titaniumnightclubNightClub instances of
