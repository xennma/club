 ...
 * Copyright (c) 2009-2012 by _titaniumnightclubNightClub, Inc. All Rights Reserved.
...
//@interface _titaniumnightclubNightClubObject : NSObject
//@end

@interface _titaniumnightclubNightClubObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[_titaniumnightclubNightClubObject class]])
		{
			for (NSString *key in [[(_titaniumnightclubNightClubObject*)o modules] allKeys])
			{
