...
@interface _titaniumnightclubNightClubObject : KrollCoverageObject {
#else
@interface _titaniumnightclubNightClubObject : KrollObject {
#endif
@private
...
extern NSString * _titaniumnightclubNightClub$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	_titaniumnightclubNightClubObject *_titaniumnightclub;
    KrollObject* console;
	BOOL shutdown;
