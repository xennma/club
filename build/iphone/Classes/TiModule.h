...
/**
 The base class for all _titaniumnightclubNightClub modules
 */
...
/**
 _titaniumnightclubNightClub Platform calls this method on startup.
 */
-(void)startup;

/**
 _titaniumnightclubNightClub Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 _titaniumnightclubNightClub Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 _titaniumnightclubNightClub Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 _titaniumnightclubNightClub Platform calls this method on resume.
 @param sender The sender of the event.
 */
