...
//Rare exceptions to indicate a bug in the _titaniumnightclub code (Eg, function that a subclass should have implemented)
...
/**
 The base class for _titaniumnightclubNightClub proxies.
 */
