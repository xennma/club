...
/**
 Base class for all _titaniumnightclubNightClub views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the _titaniumnightclubNightClub view hierarchy (such as wrapped iOS UIViews) was touched.
